...
pub const ServiceHooksClient = struct {
    ...
    pub fn notifications(self: *@This()) Notifications {
        return .{
            .endpoint = self.endpoint,
            .api_version = self.api_version,
            .pipeline = self.pipeline,
    ...
    pub fn publishers(self: *@This()) Publishers {
        return .{
            .endpoint = self.endpoint,
            .api_version = self.api_version,
            .pipeline = self.pipeline,
...
pub const Consumers = struct {
    ...
    pub fn get(self: *@This(), alloc: std.mem.Allocator, organization: []const u8, consumer_id: []const u8, publisher_id: ?[]const u8) !models.Consumer {
        ...
        const base_url = try std.fmt.allocPrint(alloc, "{s}/{s}/_apis/hooks/consumers/{s}", .{ self.endpoint, encoded_path_0, encoded_path_1 });
        defer alloc.free(base_url);
        var url_buf: std.ArrayList(u8) = .empty;
        defer url_buf.deinit(alloc);
        try url_buf.appendSlice(alloc, base_url);
        ...
        if (!responseStatusExpected(resp.status_code, &.{200})) {
            core.pager.logHttpError("Consumers.get", resp.status_code, resp.body);
            return error.AzureRequestFailed;
        }
    ...
    pub fn listConsumerActions(self: *@This(), alloc: std.mem.Allocator, organization: []const u8, consumer_id: []const u8, publisher_id: ?[]const u8) !models.ConsumerActionList {
        ...
        const encoded_path_1 = try core.url.encodePathSegment(alloc, consumer_id);
        defer alloc.free(encoded_path_1);
        const base_url = try std.fmt.allocPrint(alloc, "{s}/{s}/_apis/hooks/consumers/{s}/actions", .{ self.endpoint, encoded_path_0, encoded_path_1 });
        defer alloc.free(base_url);
        var url_buf: std.ArrayList(u8) = .empty;
        defer url_buf.deinit(alloc);
        try url_buf.appendSlice(alloc, base_url);
    ...
    pub fn getConsumerAction(self: *@This(), alloc: std.mem.Allocator, organization: []const u8, consumer_id: []const u8, consumer_action_id: []const u8, publisher_id: ?[]const u8) !models.ConsumerAction {
        ...
        const encoded_path_1 = try core.url.encodePathSegment(alloc, consumer_id);
        defer alloc.free(encoded_path_1);
        const encoded_path_2 = try core.url.encodePathSegment(alloc, consumer_action_id);
        defer alloc.free(encoded_path_2);
        const base_url = try std.fmt.allocPrint(alloc, "{s}/{s}/_apis/hooks/consumers/{s}/actions/{s}", .{ self.endpoint, encoded_path_0, encoded_path_1, encoded_path_2 });
        defer alloc.free(base_url);
        var url_buf: std.ArrayList(u8) = .empty;
        defer url_buf.deinit(alloc);
        try url_buf.appendSlice(alloc, base_url);
        ...
        if (!responseStatusExpected(resp.status_code, &.{200})) {
            core.pager.logHttpError("Consumers.getConsumerAction", resp.status_code, resp.body);
            return error.AzureRequestFailed;
        }
        return try serde.json.fromSlice(models.ConsumerAction, alloc, resp.body);
    }
};
...
pub const Notifications = struct {
    ...
    pub fn query(self: *@This(), alloc: std.mem.Allocator, organization: []const u8, body: models.NotificationsQuery) !models.NotificationsQuery {
        ...
        if (!responseStatusExpected(resp.status_code, &.{200})) {
            core.pager.logHttpError("Notifications.query", resp.status_code, resp.body);
            return error.AzureRequestFailed;
        }
    ...
    pub fn list(self: *@This(), alloc: std.mem.Allocator, organization: []const u8, subscription_id: []const u8, max_results: ?i32, status: ?enums.ListRequestStatus, result: ?enums.ListRequestResult) !models.NotificationList {
        ...
        defer alloc.free(encoded_path_1);
        const base_url = try std.fmt.allocPrint(alloc, "{s}/{s}/_apis/hooks/subscriptions/{s}/notifications", .{ self.endpoint, encoded_path_0, encoded_path_1 });
        defer alloc.free(base_url);
        var url_buf: std.ArrayList(u8) = .empty;
        defer url_buf.deinit(alloc);
        try url_buf.appendSlice(alloc, base_url);
        ...
        if (result) |query_value| {
            const sep: []const u8 = if (has_query) "&" else "?";
            const enc = try core.url.percentEncode(alloc, query_value.toWire());
            defer alloc.free(enc);
            try url_buf.print(alloc, "{s}result={s}", .{ sep, enc });
            has_query = true;
        }
    ...
    pub fn get(self: *@This(), alloc: std.mem.Allocator, organization: []const u8, subscription_id: []const u8, notification_id: i32) !models.Notification {
        ...
        const encoded_path_1 = try core.url.encodePathSegment(alloc, subscription_id);
        defer alloc.free(encoded_path_1);
        const encoded_path_2 = try core.url.encodePathSegment(alloc, notification_id);
        defer alloc.free(encoded_path_2);
        const base_url = try std.fmt.allocPrint(alloc, "{s}/{s}/_apis/hooks/subscriptions/{s}/notifications/{s}", .{ self.endpoint, encoded_path_0, encoded_path_1, encoded_path_2 });
        defer alloc.free(base_url);
        var url_buf: std.ArrayList(u8) = .empty;
        defer url_buf.deinit(alloc);
        try url_buf.appendSlice(alloc, base_url);
        ...
        if (!responseStatusExpected(resp.status_code, &.{200})) {
            core.pager.logHttpError("Notifications.get", resp.status_code, resp.body);
            return error.AzureRequestFailed;
        }
        return try serde.json.fromSlice(models.Notification, alloc, resp.body);
    }
    ...
    pub fn create(self: *@This(), alloc: std.mem.Allocator, organization: []const u8, use_real_data: ?bool, body: models.Notification) !models.Notification {
        ...
        try url_buf.appendSlice(alloc, base_url);
        var has_query = std.mem.indexOfScalar(u8, base_url, '?') != null;
        if (use_real_data) |query_value| {
            const sep: []const u8 = if (has_query) "&" else "?";
            try url_buf.print(alloc, "{s}useRealData={}", .{ sep, query_value });
            has_query = true;
        }
        const encoded_query_1 = try core.url.percentEncode(alloc, self.api_version);
        defer alloc.free(encoded_query_1);
        ...
        if (!responseStatusExpected(resp.status_code, &.{200})) {
            core.pager.logHttpError("Notifications.create", resp.status_code, resp.body);
            return error.AzureRequestFailed;
        }
        return try serde.json.fromSlice(models.Notification, alloc, resp.body);
    }
...
pub const Publishers = struct {
    ...
    pub fn get(self: *@This(), alloc: std.mem.Allocator, organization: []const u8, publisher_id: []const u8) !models.Publisher {
        ...
        defer alloc.free(encoded_path_1);
        const base_url = try std.fmt.allocPrint(alloc, "{s}/{s}/_apis/hooks/publishers/{s}", .{ self.endpoint, encoded_path_0, encoded_path_1 });
        defer alloc.free(base_url);
        var url_buf: std.ArrayList(u8) = .empty;
        defer url_buf.deinit(alloc);
        try url_buf.appendSlice(alloc, base_url);
        ...
        if (!responseStatusExpected(resp.status_code, &.{200})) {
            core.pager.logHttpError("Publishers.get", resp.status_code, resp.body);
            return error.AzureRequestFailed;
        }
    ...
    pub fn listEventTypes(self: *@This(), alloc: std.mem.Allocator, organization: []const u8, publisher_id: []const u8) !models.EventTypeDescriptorList {
        ...
        const encoded_path_1 = try core.url.encodePathSegment(alloc, publisher_id);
        defer alloc.free(encoded_path_1);
        const base_url = try std.fmt.allocPrint(alloc, "{s}/{s}/_apis/hooks/publishers/{s}/eventtypes", .{ self.endpoint, encoded_path_0, encoded_path_1 });
        defer alloc.free(base_url);
        var url_buf: std.ArrayList(u8) = .empty;
        defer url_buf.deinit(alloc);
        try url_buf.appendSlice(alloc, base_url);
    ...
    pub fn getEventType(self: *@This(), alloc: std.mem.Allocator, organization: []const u8, publisher_id: []const u8, event_type_id: []const u8) !models.EventTypeDescriptor {
        ...
        const encoded_path_1 = try core.url.encodePathSegment(alloc, publisher_id);
        defer alloc.free(encoded_path_1);
        const encoded_path_2 = try core.url.encodePathSegment(alloc, event_type_id);
        defer alloc.free(encoded_path_2);
        const base_url = try std.fmt.allocPrint(alloc, "{s}/{s}/_apis/hooks/publishers/{s}/eventtypes/{s}", .{ self.endpoint, encoded_path_0, encoded_path_1, encoded_path_2 });
        defer alloc.free(base_url);
        var url_buf: std.ArrayList(u8) = .empty;
        defer url_buf.deinit(alloc);
        try url_buf.appendSlice(alloc, base_url);
        ...
        if (!responseStatusExpected(resp.status_code, &.{200})) {
            core.pager.logHttpError("Publishers.getEventType", resp.status_code, resp.body);
            return error.AzureRequestFailed;
        }
        return try serde.json.fromSlice(models.EventTypeDescriptor, alloc, resp.body);
    }
    ...
    pub fn queryInputValues(self: *@This(), alloc: std.mem.Allocator, organization: []const u8, publisher_id: []const u8, body: models.InputValuesQuery) !models.InputValuesQuery {
        ...
        const encoded_path_1 = try core.url.encodePathSegment(alloc, publisher_id);
        defer alloc.free(encoded_path_1);
        const base_url = try std.fmt.allocPrint(alloc, "{s}/{s}/_apis/hooks/publishers/{s}/inputValuesQuery", .{ self.endpoint, encoded_path_0, encoded_path_1 });
        defer alloc.free(base_url);
        var url_buf: std.ArrayList(u8) = .empty;
        defer url_buf.deinit(alloc);
        try url_buf.appendSlice(alloc, base_url);
        ...
        if (!responseStatusExpected(resp.status_code, &.{200})) {
            core.pager.logHttpError("Publishers.queryInputValues", resp.status_code, resp.body);
            return error.AzureRequestFailed;
        }
        return try serde.json.fromSlice(models.InputValuesQuery, alloc, resp.body);
    }
    ...
    pub fn queryPublishers(self: *@This(), alloc: std.mem.Allocator, organization: []const u8, body: models.PublishersQuery) !models.PublishersQuery {
        ...
        if (!responseStatusExpected(resp.status_code, &.{200})) {
            core.pager.logHttpError("Publishers.queryPublishers", resp.status_code, resp.body);
            return error.AzureRequestFailed;
        }
        return try serde.json.fromSlice(models.PublishersQuery, alloc, resp.body);
    }
};
...
pub const Subscriptions = struct {
    ...
    pub fn list(self: *@This(), alloc: std.mem.Allocator, organization: []const u8, publisher_id: ?[]const u8, event_type: ?[]const u8, consumer_id: ?[]const u8, consumer_action_id: ?[]const u8) !models.SubscriptionList {
        ...
        if (event_type) |query_value| {
            const sep: []const u8 = if (has_query) "&" else "?";
            const enc = try core.url.percentEncode(alloc, query_value);
            defer alloc.free(enc);
            try url_buf.print(alloc, "{s}eventType={s}", .{ sep, enc });
            has_query = true;
        }
        if (consumer_id) |query_value| {
            const sep: []const u8 = if (has_query) "&" else "?";
            const enc = try core.url.percentEncode(alloc, query_value);
            defer alloc.free(enc);
            try url_buf.print(alloc, "{s}consumerId={s}", .{ sep, enc });
            has_query = true;
        }
        if (consumer_action_id) |query_value| {
            const sep: []const u8 = if (has_query) "&" else "?";
            const enc = try core.url.percentEncode(alloc, query_value);
            defer alloc.free(enc);
            try url_buf.print(alloc, "{s}consumerActionId={s}", .{ sep, enc });
            has_query = true;
        }
    ...
    pub fn create(self: *@This(), alloc: std.mem.Allocator, organization: []const u8, body: models.Subscription) !models.Subscription {
        ...
        return try serde.json.fromSlice(models.Subscription, alloc, resp.body);
    }
    ...
    pub fn delete(self: *@This(), alloc: std.mem.Allocator, organization: []const u8, subscription_id: []const u8) !void {
        ...
        const encoded_path_1 = try core.url.encodePathSegment(alloc, subscription_id);
        defer alloc.free(encoded_path_1);
        const base_url = try std.fmt.allocPrint(alloc, "{s}/{s}/_apis/hooks/subscriptions/{s}", .{ self.endpoint, encoded_path_0, encoded_path_1 });
        defer alloc.free(base_url);
        var url_buf: std.ArrayList(u8) = .empty;
        defer url_buf.deinit(alloc);
        try url_buf.appendSlice(alloc, base_url);
    ...
    pub fn replaceSubscription(self: *@This(), alloc: std.mem.Allocator, organization: []const u8, subscription_id: []const u8, body: models.Subscription) !models.Subscription {
        ...
        if (!responseStatusExpected(resp.status_code, &.{200})) {
            core.pager.logHttpError("Subscriptions.replaceSubscription", resp.status_code, resp.body);
            return error.AzureRequestFailed;
        }
        return try serde.json.fromSlice(models.Subscription, alloc, resp.body);
    }
    ...
    pub fn createSubscriptionsQuery(self: *@This(), alloc: std.mem.Allocator, organization: []const u8, body: models.SubscriptionsQuery) !models.SubscriptionsQuery {
        ...
        if (!responseStatusExpected(resp.status_code, &.{200})) {
            core.pager.logHttpError("Subscriptions.createSubscriptionsQuery", resp.status_code, resp.body);
            return error.AzureRequestFailed;
        }
        return try serde.json.fromSlice(models.SubscriptionsQuery, alloc, resp.body);
    }
};
...
pub const Diagnostics = struct {
    ...
    pub fn get(self: *@This(), alloc: std.mem.Allocator, organization: []const u8, subscription_id: []const u8) !models.SubscriptionDiagnostics {
        ...
        const encoded_path_1 = try core.url.encodePathSegment(alloc, subscription_id);
        defer alloc.free(encoded_path_1);
        const base_url = try std.fmt.allocPrint(alloc, "{s}/{s}/_apis/hooks/subscriptions/{s}/diagnostics", .{ self.endpoint, encoded_path_0, encoded_path_1 });
        defer alloc.free(base_url);
        var url_buf: std.ArrayList(u8) = .empty;
        defer url_buf.deinit(alloc);
        try url_buf.appendSlice(alloc, base_url);
