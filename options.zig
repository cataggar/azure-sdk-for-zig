...
pub const SetServicePropertiesOptions = struct { protocol: ProtocolOptions = .{}, };
pub const GetServicePropertiesOptions = struct { protocol: ProtocolOptions = .{}, };
pub const GetStatisticsOptions = struct { protocol: ProtocolOptions = .{}, };
